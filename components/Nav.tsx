        ...
        <div className="flex justify-between w-full  items-center px-8 py-4 text-gray">
          ...
          <div className="flex space-x-4">
            ...
            <>
                ...
                <>
                    <Link href="/sign-up" className="px-3 py-2 text-sm font-medium text-gray hover:text-gray-500">Log in</Link>
                    <Link href="/sign-in" className="px-6 py-2 rounded-full text-sm font-medium text-white  bg-blue-500 hover:bg-blue-700">Sign up</Link>
                </>
            )}
